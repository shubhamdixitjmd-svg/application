...
```html name=index.html url=https://github.com/shubhamdixitjmd-svg/application/blob/main/index.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div id="root"></div>
    <!-- main.tsx is at the repository root in this project layout -->
    <script type="module" src="/main.tsx"></script>
  </body>
</html>
```

```json name=package.json url=https://github.com/shubhamdixitjmd-svg/application/blob/main/package.json
{
  "name": "train-maintenance-frontend",
  "private": true,
  "version": "1.0.0",
  "type": "module",
  "scripts": {
